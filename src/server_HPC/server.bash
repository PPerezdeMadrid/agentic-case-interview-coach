...
echo "Starting HF/FastAPI LLM servers (Mistral-Small-24B + Llama-3.3-70B)"
...
# Mistral-Small-24B fits comfortably on a single A100 (same footprint as Nemo).
...
wait_for_server "Mistral-Small-24B" 18403 || { kill "$MISTRAL_PID" "$LLAMA_PID" 2>/dev/null; exit 1; }
wait_for_server "Llama-3.3-70B" 18402 1800 || { kill "$MISTRAL_PID" "$LLAMA_PID" 2>/dev/null; exit 1; }

echo "Both servers are up:"
echo "  - Mistral-Small-24B: http://127.0.0.1:18403/v1/models"
