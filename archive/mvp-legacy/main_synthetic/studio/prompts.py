...
JUDGE_SYSTEM_PROMPT = (
    ...
    "\n\n"
    "If the evidence is not yet sufficient, choose decision \"continue\" and tell the interviewer exactly what to probe next based on the case guidance and the gaps in the transcript. "
    "If the evidence is sufficient, choose decision \"score\" and provide final evaluative feedback with a score from 1 to 5 based on the full interaction and the rubric. "
    ...
    "}. "
    "\n\n"
    "If decision is \"continue\": final_score must be 0, enough_evidence must be false, and interviewer_guidance must be specific about what the interviewer should redirect toward next. "
...
JUDGE_GRAPH_SYSTEM_PROMPT = (
    ...
    "\"interviewer_guidance\": \"short private instruction\", "
